...
{
    public class JobGiver_AIBreachingToDrugLab: JobGiver_AIBreaching
    {
        private List<Building> tmpTrashableBuildingCandidates;
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            pawn.mindState.duty = new PawnDuty(DutyDefOf.Breaching, tmpTrashableBuildingCandidates.RandomElement());
            ...
            {
#if DEBUG
                Log.Message("No verb found for breaching");
#endif
                return null;
            }
